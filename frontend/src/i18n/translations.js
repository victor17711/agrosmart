export const translations = {
  ro: {
    ...
    home: {
      ...
      heroSubtitle: 'Tehnologie inovatoare la prețuri accesibile',
      shopNow: 'Cumpără acum',
      trending: 'Tendințe',
      bestSeller: 'Best Seller',
      newArrival: 'Nou sosit',
      sale: 'Reducere',
      hotPicks: 'Oferte Fierbinți Astăzi',
      viewAll: 'Vezi toate',
    ...
    product: {
      ...
      payInInstallments: 'Achită în 3 rate',
      installmentsDescription: 'Plătește în 3 rate fără dobândă',
    ...
    cart: {
      ...
      proceedToCheckout: 'Mergi la checkout',
      remove: 'Șterge',
      update: 'Actualizează'
    },
  ...
  ru: {
    ...
    home: {
      heroTitle: 'Скидки до',
      heroSubtitle: 'Инновационные технологии по доступным ценам',
      shopNow: 'Купить сейчас',
      trending: 'Тренды',
      bestSeller: 'Бестселлер',
      newArrival: 'Новинка',
      sale: 'Распродажа',
      hotPicks: 'Горячие предложения сегодня',
    ...
    product: {
      ...
      payInInstallments: 'Оплата в 3 платежа',
      installmentsDescription: 'Платите в 3 платежа без процентов',
